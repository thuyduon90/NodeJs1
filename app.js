...
// Database connection
mongoose.connect(`mongodb+srv://${databaseInfo.username}:${databaseInfo.password}@${databaseInfo.database}-k6kid.gcp.mongodb.net/NodeJS1?retryWrites=true&w=majority`, { useNewUrlParser: true });
// =================================
